...
const queries = {
	...
	SendStreamChatMessage: (linoUsername: string, message: string) => `{"operationName":"SendStreamChatMessage","variables":{"input":{"streamer":"${linoUsername}","message":"${message}","roomRole":"Member","subscribing":true}},"extensions":{"persistedQuery":{"version":1,"sha256Hash":"e755f412252005c7d7865084170b9ec13547e9951a1296f7dfe92d377e760b30"}}}`,
